...
class PopupBannerDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final hasImage = (popupBannerModel.image ?? '').trim().isNotEmpty;
    final hasTitle = (popupBannerModel.title ?? '').trim().isNotEmpty;
    final hasSummary = (popupBannerModel.summary ?? '').trim().isNotEmpty;
    final hasButton = (popupBannerModel.btnText ?? '').trim().isNotEmpty;

    // ✅ صورة بس بدون أي نصوص/زر
    final isImageOnly = hasImage && !hasTitle && !hasSummary && !hasButton;
